...
const Update = () => {
  ...
  const url = `https://go-server-2htl.onrender.com/api/goals/${goalId}`;
  ...
  return (
    <>
      ...
      {
        isLoading ?  <Loading />  : <div className="container d-flex justify-content-between align-items-center mt-3 pb-3 gap-lg-2">
